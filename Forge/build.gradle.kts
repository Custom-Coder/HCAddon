...
loom {
    forge {
        ...
        mixinConfig(
            "hcaddon-common.mixins.json",
            "hcaddon-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hcaddon.apply-datagen-mixin", "true")
                property("hcaddon.$platform-datagen", "true")
            }
        }
    }
}

hcaddonModDependencies {
