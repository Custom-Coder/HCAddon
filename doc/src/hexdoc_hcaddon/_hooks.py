...
import hexdoc_hcaddon

from .__gradle_version__ import FULL_VERSION, MINECRAFT_VERSION, MOD_ID, MOD_VERSION
from .__version__ import PY_VERSION


class HcaddonPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HcaddonModPlugin(branch=branch)


class HcaddonModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return MOD_ID
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hcaddon, "_templates"
