...
abstract class HcaddonModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HcaddonModDependenciesExtension>("hcaddonModDependencies")
